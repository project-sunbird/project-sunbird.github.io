...
Just as Sunbird code follows coding standards and guidelines, it’s documentation has some simple rules. Go through the Structure your Document section and the handy [cheat sheet](contributions/sunbird_styleguide_cheatsheet){:target="_blank"} to the Sunbird style guide to avoid rework on the pages you submit. 
