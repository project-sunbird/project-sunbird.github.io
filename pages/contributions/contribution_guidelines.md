...
## Writing Guidelines
Just as the Sunbird code follows coding standards and guidelines, the documentation has some simple conventions to follow. Please see the [How to structure a document?](contributions/contribution_guidelines/#link1-1-1) section and the [Sunbird style guide](contributions/styleguide) which follows to ensure the pages you submit are consistent with the rest of Sunbird's documentation. 
