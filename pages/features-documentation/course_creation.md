...
<table>
  ...
  <tr>
    <td>1. Click <b>Save</b> on the header to save the course <br>2. Click <b>Limited sharing</b> to publish the lesson to the limited audiences <br><b>Note</b>: Refer <a href="features-documentation/limitedshare" target="_blank">Limited Publishing</a> to view and share all the contents created and ready for sharing. <br>3. Click <b>Send for review</b> to send the created course for review
    </td>
