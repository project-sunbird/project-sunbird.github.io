...
<table>
  ...
  <tr>
    <td>To add content to the course, you can either <br>&emsp;a) Click <b>Add Resource</b> from the burger menu associated with the required node in the left navigation pane, <b>OR</b> <br>&emsp;b) Right-click on the node name and select <b>Add Resource</b>, <b>OR</b> <br>&emsp;c) Use the keyboard shortcut <b>Ctrl+Alt+A</b>
    </td>
    <td><img src="pages/features-documentation/images/course/addcontent.png"></td>
  </tr>
</table>
