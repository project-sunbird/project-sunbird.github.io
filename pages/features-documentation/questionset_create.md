...
### Selecting Questions - Using filter
  ...
  <tr>
    <td>1. Type keywords to search for resources. 
    ...
    <br>3. Use the <b>My Questions</b> slider to search for questions that you have uploaded. To search for questions available on the portal, disable this option. The search result is displayed on the left pane
...
<table>
 <tr>
  ...
  <tr>
    <td>1. To create a question set <br>1.Select the type of question you want to create
      <br>2. You can create following types of question  
      <br>&emsp;a) <b>Creating Multiple Choice Question Set</b>
      <br>&emsp;b) <b>Creating Fill in the Blanks Question Set</b> 
      <br>&emsp;c) <b>Creating Match the Following Question Set</b> 
...
<br>1. Enter the question. You can format the questions using rich text editor 
<br>2. Enter the answers 
<br>Mark the correct answer amongst the multiple answers 
...
<br>Select <b>Add answer</b> to add another option in the Mark as Right multiple choice 
<br>Click <b>Refresh</b> icon to preview your question 
