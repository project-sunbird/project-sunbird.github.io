...
&emsp;<b>Note:</b> You can attach or give link for more than one file. For attachements the following file formats are supported: .pdf, .png, .jpg. Maximum file size limit is 1MB.
