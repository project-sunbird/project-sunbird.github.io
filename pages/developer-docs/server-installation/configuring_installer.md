...
1. Install git and run the following commands:
...
1. Once the repository is successfully cloned, run the following commands:

`git checkout tags/release-1.9
`cd deploy` 


2. Update the configuration parameters in the `config` file. 
