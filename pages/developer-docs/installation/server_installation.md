...
10.Open https://[domain-name] and verify your installation by logging in with the user ID as:  username@channelName he password file provided in config file 
