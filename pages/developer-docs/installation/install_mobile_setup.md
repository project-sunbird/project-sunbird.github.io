...
<table>
  ...
  <tr>
    <td>6.</td>
    <td>To get the API key, create an account in <a href="https://get.fabric.io/">fabric.io</a> and to get the fabric API key . After registering your app, you will get the API Key, refer <a href="https://docs.fabric.io/android/fabric/settings/api-keys.html">here</a>. Add the key in the manifest file.<br><strong>Note:</strong>Every application has an <strong>AndroidManifest.xml</strong> file in its root directory</td>
  </tr>
  <tr>
    <td>7.</td>
